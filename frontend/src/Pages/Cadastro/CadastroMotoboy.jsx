...
import imgMotoboy from '../../../public/motoboyImg.png'
  ...
  return (
    <Container>
      <LeftPanel>
        ...
        <DeliveryImage src={imgMotoboy}alt="Delivery illustration" />
      </LeftPanel>
      ...
      <RightPanel>
        <Form onSubmit={handleSubmit}>
          ...
          <FormGroup>
            ...
            <Input type="tel" placeholder="(DDD) 9999-9999" />
          </FormGroup>
          
          <SubmitButton type="submit">cadastre-se</SubmitButton>
          
          <LoginLink href="/login-motoboy">Já possui uma conta?</LoginLink>
        </Form>
      </RightPanel>
    </Container>
  );
