    ...
    <Container>
      ...
      <RightPanel>
        <Form onSubmit={handleSubmit}>
          ...
          <LoginButton type="button" value='Entrar' onClick={(e) => [e.preventDefault(), window.location.href='/']}></LoginButton>

          <CreateAccount href="#">Esqueceu a senha?</CreateAccount>
          
          <CreateAccount href="/cadastro-motoboy">Não possui uma conta?</CreateAccount>
        </Form>
      </RightPanel>
    </Container>
  );
